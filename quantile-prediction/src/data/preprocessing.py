...
class FrameTorch(object):
    ...
    def split_data(self, train_size=0.8, val_size=0.1, test_size=0.1):
        ...
        self.n_val = int(self.n * val_size)
        self.n_test = self.n - (self.n_train + self.n_val)
        
        # datasets
        self.data_train = self.data[:self.n_train, :]
        self.data_val = self.data[self.n_train:(self.n_train + self.n_val), :]
        self.data_test = self.data[-self.n_test:, :]
